...
56-to-92-point viewport budget. The topology viewport uses 280-to-480 points;
dense graph content scrolls inside that reservation. Upload and download each use their own

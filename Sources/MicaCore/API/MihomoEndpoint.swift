...
public struct MihomoEndpoint: Sendable {
    ...
    public static let smartWeights = MihomoEndpoint(pathComponents: ["group", "weights"])
    ...
    public static func smartGroupWeights(group: String) -> MihomoEndpoint {
        MihomoEndpoint(pathComponents: ["group", group, "weights"])
    }

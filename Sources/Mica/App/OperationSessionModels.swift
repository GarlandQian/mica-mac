...
struct ConnectionTransferRateTracker: Equatable {
...
struct ControllerSessionRuntimeState: Equatable {
    ...
    mutating func recordMemory(_ memory: MemoryResponse) {
    ...
    mutating func recordSingBoxStatus(_ status: SingBoxStatusSnapshot) {
...
struct ControllerSessionLiveObservation: Equatable {
...
enum ControllerSessionLiveObservationState: Equatable {
    case idle
    case connecting
    case observing
    case nearLive
...
enum ControllerSessionLiveSource: Equatable {
    case none

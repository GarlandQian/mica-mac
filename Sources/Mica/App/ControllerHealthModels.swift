...
struct ConnectionTestReport: Equatable {
    ...
    static func failure(
        draft: RouterDraft,
        error: Error,
        resolvedKind: ControllerKind? = nil,
        language: AppLanguage = MicaStrings.appLanguage
    ) -> ConnectionTestReport {
        let diagnosis = ConnectionFailureDiagnosis(error: error, language: language)

        if resolvedKind == .singBoxCompatible || error is SingBoxGRPCError {
            return ConnectionTestReport(
                summary: diagnosis.summary,
                headline: diagnosis.headline,
                targetURL: draft.visibleControllerTargetLabel(language: language),
                steps: [
                    ConnectionCheckStep(id: "controller-type", title: MicaStrings.localized("editor.controller_type", language: language), value: ControllerKind.singBoxCompatible.micaLabel(language: language), state: .ready),
                    ...
                    ConnectionCheckStep(id: "adapter", title: MicaStrings.localized("editor.adapter", language: language), value: MicaStrings.localized("editor.sing_box_started_service", language: language), state: .failed),
    ...
    static func singBoxSuccess(
        ...
        ConnectionTestReport(
            summary: .ready,
            headline: MicaStrings.localized("editor.report_ready \(version.version)", language: language),
            targetURL: draft.visibleControllerTargetLabel(language: language),
            steps: [
                ConnectionCheckStep(id: "controller-type", title: MicaStrings.localized("editor.controller_type", language: language), value: ControllerKind.singBoxCompatible.micaLabel(language: language), state: .ready),
                ConnectionCheckStep(id: "url", title: MicaStrings.localized("editor.hs_url", language: language), value: draft.visibleControllerTargetLabel(language: language), state: .ready),
                ConnectionCheckStep(id: "tls", title: MicaStrings.localized("editor.hs_tls", language: language), value: draft.tlsCheckLabel(language: language), state: .ready),
                ConnectionCheckStep(id: "secret", title: MicaStrings.localized("editor.hs_secret", language: language), value: draft.secretCheckLabel(language: language), state: draft.secretCheckState),
                ConnectionCheckStep(id: "adapter", title: MicaStrings.localized("editor.adapter", language: language), value: MicaStrings.localized("editor.sing_box_started_service", language: language), state: .ready),
                ConnectionCheckStep(id: "version", title: MicaStrings.localized("editor.hs_version", language: language), value: version.version, state: .ready),
                ConnectionCheckStep(id: "api-version", title: MicaStrings.localized("editor.api_version", language: language), value: version.apiVersion.formatted(), state: .ready),
            ],
            nextStep: MicaStrings.localized("action.refresh", language: language)
        )
    }

...
extension AppModel {
    ...
    func controllerDiagnosticsReport() -> String {
        ...
        return [
            ...
            localized("diagnostics.version \(controllerMetadata.versionLabel)"),
            localized("diagnostics.mode \(MicaStrings.displayMode(controllerMetadata.mode, language: presentationLanguage))"),
            localized("diagnostics.policy_groups \(policyGroupCatalog.groups.count)"),
            localized("diagnostics.connections \(connectionsCatalog.connections.count)"),
            localized("diagnostics.rules \(rulesCatalog.rules.count)"),
            localized("diagnostics.proxy_providers \(providersCatalog.providers.count)"),
            ...
            localized("diagnostics.insight \(insightCatalog.diagnosticsStats)"),
    ...
    func diagnosticsReportDisplayPreview() -> String {
        ...
        return [
            ...
            localized("diagnostics.insight \(insightCatalog.diagnosticsStatsSummary(language: presentationLanguage))"),
            localized("diagnostics.report_policy"),
        ].joined(separator: "\n")
    }

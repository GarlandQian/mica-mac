...
enum AppRuntimeSmokeProbe {
    ...
    private static func menuSamples(language _: AppLanguage) -> [String: String] {
        let menuLanguage = AppLanguage.menuBarLanguage

        return [
            "navigation.view_menu": localize("navigation.view_menu", language: menuLanguage),
            "controller.command_menu": localize("controller.command_menu", language: menuLanguage),
            "command.menu_new_controller": localize("command.menu_new_controller", language: menuLanguage),
            "command.menu_test_connection": localize("command.menu_test_connection", language: menuLanguage),
            "command.menu_refresh_data": localize("command.menu_refresh_data", language: menuLanguage),
            "command.menu_copy_diagnostics_report": localize("command.menu_copy_diagnostics_report", language: menuLanguage),
            "live.pause": localize("live.pause", language: menuLanguage),
            "sidebar.edit": localize("sidebar.edit", language: menuLanguage),
        ]
    }
    ...
    private static func fontScaleProbe(for fontScale: AppFontScale) -> FontScaleProbe {
        FontScaleProbe(
            ...
            multiplier: fontScale.multiplier,
            calloutPointSize: fontScale.pointSize(for: 12)
        )
    }

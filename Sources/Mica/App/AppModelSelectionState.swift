...
extension AppModel {
    ...
    var routingGroupsForSession: [ProxyGroupViewState] {
        dashboard.groups
    }

    var selectedPolicyGroupID: ProxyGroupViewState.ID? {
        policyGroupPresentation.selectedPolicyGroupID
    }

    func selectPolicyGroup(_ groupID: ProxyGroupViewState.ID) {
        policyGroupPresentation.select(groupID)
    }

    func reconcilePolicyGroupPresentation() {
        policyGroupPresentation.reconcile(with: dashboard.groups)
    }
    ...
    func selectRouter(_ router: RouterProfile) {
        ...
        resetControllerScopedPresentation()
    ...
    private func resetControllerScopedPresentation() {
